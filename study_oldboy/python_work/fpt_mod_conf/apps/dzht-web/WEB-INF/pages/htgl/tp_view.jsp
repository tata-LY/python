...
<body onload="buqueDiv()">
	...
	<div class="ht_main container"  style="padding-left: 0px; padding-right: 0px;">
		<div class="row jssor_1" id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1170px; height: 588px; overflow: hidden; visibility: hidden; background-color:rgb(249, 249, 249);">
			<!-- Loading Screen -->
			...
			<div class="col-xs-3 ht_right">
				<div class="ht_yeqian">
					...
					<!-- Thumbnail Navigator -->
					<div data-u="thumbnavigator" class="jssort01-99-66" data-autocenter="2" style="position:absolute;right:0px;top:140px;width:277px;height:380px;" >
